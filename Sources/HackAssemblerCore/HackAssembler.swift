...
public struct HackAssembler {
    ...
    private static let jumpMap: [String: String] = [
        "JGT": "001",
        "JEQ": "010",
        "JGE": "011",
        "JLT": "100",
    ...
    private static let destinationMap: [String: String] = [
        "M"  : "001",
        "D"  : "010",
        "MD" : "011",
        "A"  : "100",
    ...
    private static let computationMap: [String: String] = [
        "0"  : "0101010",
        "1"  : "0111111",
        "-1" : "0111010",
        "D"  : "0001100",
    ...
    private static func translateNoSymbols(lines: [String]) throws -> [String] {
        return try lines.map(translateLineNoSymbols)
    }
    
    private static func translateLineNoSymbols(line: String) throws -> String {
        switch line.first! {
    ...
    private static func parseAddress(line: String) throws -> String {
    ...
    private static func translateInstruction(line: String) throws -> String {
    ...
    private static func translateJump(_ jump: Substring?) throws -> String {
    ...
    private static func translateDestination(_ destination: Substring?) throws -> String {
    ...
    private static func translateCompute(_ computation: Substring) throws -> String {
    ...
    private static func parseInstructionComponents(_ line: String) throws -> InstructionComponents {
        let jumpInstruction: Substring?
        let destinationInstruction: Substring?
        let computeInstruction: Substring
